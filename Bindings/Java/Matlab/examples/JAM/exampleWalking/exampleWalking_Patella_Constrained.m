...
comak_ik.set_secondary_coordinates(5,'/jointset/pf_r/pf_rot_r');
comak_ik.set_secondary_coordinates(6,'/jointset/pf_r/pf_tilt_r');
...
comak.set_start_time(1.28);
comak.set_stop_time(1.91);
